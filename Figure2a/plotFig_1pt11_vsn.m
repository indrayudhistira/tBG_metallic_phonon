...
strparame{1} = ['$\tilde{\beta}_A^{(e)}=' sprintf('%.0f', betaAtildeeVe) ' \pm ' sprintf('%.0f', 2 * deltabetaAtildeeVe) '$~eV'];
strparame{2} = ['$v_F^{(e)}/v_0=' sprintf('%.2f', vbare) ' \pm ' sprintf('%.2f', 2 * deltavbare) '$'];
annotation('textbox', [.24 .34 .1 .1], 'String', strparame, 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 15);
strparamh{1} = ['$\tilde{\beta}_A^{(h)}=' sprintf('%.0f', betaAtildeeVh) ' \pm ' sprintf('%.0f', 2 * deltabetaAtildeeVh) '$~eV'];
strparamh{2} = ['$v_F^{(h)}/v_0=' sprintf('%.2f', vbarh) ' \pm ' sprintf('%.2f', 2 * deltavbarh) '$'];
...
strparame{1} = ['$C_e=' sprintf('%.1f', Ce) ' \pm ' sprintf('%.1f', 2 * deltaCe) '$'];
strparame{2} = ['$v_F^{(e)}/v_0=' sprintf('%.1f', vbare) ' \pm ' sprintf('%.1f', 2 * deltavbare) '$'];
annotation('textbox', [.835 .3 .1 .1], 'String', strparame, 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 15);
strparamh{1} = ['$C_h=' sprintf('%.1f', Ch) ' \pm ' sprintf('%.1f', 2 * deltaCh) '$'];
strparamh{2} = ['$v_F^{(h)}/v_0=' sprintf('%.2f', vbarh) ' \pm ' sprintf('%.2f', 2 * deltavbarh) '$'];
