...
load  Rho_vs_theta_relaxezzi_new_T10_n5.mat
...
plot(linspace(1.09,1.09,10),linspace(0.,0.02,10),'r','LineWidth',3)
plot(linspace(1.17,1.17,10),linspace(0.,0.02,10),'r','LineWidth',3)

thetam = 1.13; % for relaxed carr
...
xx1 = linspace(0.3, cross(5),10);
yy1 = linspace(0,5,10);
a11=area(xx1,yy1);
a11.FaceAlpha = 0.1;
a11.FaceColor = [1 0 0];
 
xx1 = linspace(cross(5), cross(6),10);
yy1 = linspace(0,10,10);
a11=area(xx1,yy1);
a11.FaceAlpha = 0.19;
a11.FaceColor = [0 0 1];

xx1 = linspace(cross(6), 1.21,10);
...
X = [0.68 0.82];
Y = [stry-0.3   stry-0.3];
annotation('arrow',X,Y,'Color','Black');

dim = [0.73 stry-0.73 0.3 0.3];
str = {'$\theta_{cr}$' };
annotation('textbox',dim,'String',str,'LineStyle','none','FontSize',cc-4,'FontWeight', 'bold','Interpreter', 'latex','FontName','Times New Roman', 'Color', 'Black');

dim = [0.84 stry-0.73 0.3 0.3];
str = {'$\theta_{cr}$' };
annotation('textbox',dim,'String',str,'LineStyle','none','FontSize',cc-4,'FontWeight', 'bold','Interpreter', 'latex','FontName','Times New Roman', 'Color', 'Black');

dim = [0.83 stry-0.54 0.3 0.3];
str = {'$\theta_{M}$' };
annotation('textbox',dim,'String',str,'LineStyle','none','FontSize',cc-4,'FontWeight', 'bold','Interpreter', 'latex','FontName','Times New Roman', 'Color', 'Black');
...
annotation('textbox', [0 0.8 .1 .1], 'String', '(c)', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);

ax = gca;
% exportgraphics(ax,'Fig-Relax-b.pdf','Resolution',300) 
