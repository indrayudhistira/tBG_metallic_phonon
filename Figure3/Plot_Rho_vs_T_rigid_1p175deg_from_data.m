...
str = '$\frac{T_{BG}}{4}$';
annotation('textbox',dim,'String',str,'LineStyle','none','FontSize',cc-3,'FontWeight', 'bold','Interpreter', 'latex','FontName','Times New Roman', 'Color', strcolor);
...
strcolor = 'Black';
dim = [strx+0.23 stry-0.23 0.3 0.3];
...
strcolor = 'Black';
dim = [strx+0.23 stry-0.28 0.3 0.3];
str = '\textit{Intraband}';
annotation('textbox',dim,'String',str,'LineStyle','none','FontSize',cc-5,'FontWeight', 'bold','Interpreter', 'latex','FontName','Times New Roman', 'Color', strcolor);
