...
p(1) = plot(n_exp, (rho_exp - rho_exp(1)) / rho_exp(1), 'ks', 'MarkerSize', 7, 'MarkerFaceColor', 'k', 'DisplayName', ['Experiment' newline '(Columbia-UCSB, Ref.~13)']);
...
l = legend(p);
legend boxoff;
set(l, 'Interpreter', 'latex', 'FontSize', 16, 'Position', [.65 .64 .1 .1]); %, 'Position', [.385 .48 .1 .1]
...
annotation('textbox', [.68 .15 .1 .1], 'String', 'Electron', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
