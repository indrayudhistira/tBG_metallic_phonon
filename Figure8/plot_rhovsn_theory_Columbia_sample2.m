...
p(1) = plot(flipud(-n_exp), flipud((rho_exp - rho_exp(end)) / rho_exp(end)), 'ks', 'MarkerSize', 7, 'MarkerFaceColor', 'k', 'DisplayName', ['Experiment' newline '(Columbia-UCSB, Ref.~13)']);
...
l = legend(p);
legend boxoff;
set(l, 'Interpreter', 'latex', 'FontSize', 16, 'Position', [.65 .65 .1 .1]); %, 'Position', [.385 .48 .1 .1]
...
annotation('textbox', [.79 .15 .1 .1], 'String', 'Hole', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
% annotation('textbox', [.45 .17 .1 .1], 'String', ['$n_\mathrm{rms}=' num2str(nrms) '\times 10^{10}\mathrm{cm}^{-2}$'], 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
