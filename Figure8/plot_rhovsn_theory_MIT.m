...
p(1) = plot(flipud(-n_exp), flipud((rho_exp - rho_exp(end)) / rho_exp(end)), 'ks', 'MarkerSize', 7, 'MarkerFaceColor', 'k', 'DisplayName', 'Experiment (MIT, Ref.~2)');
...
l = legend(p);
legend boxoff;
set(l, 'Interpreter', 'latex', 'FontSize', 16, 'Position', [.66 .67 .1 .1]); %, 'Position', [.385 .48 .1 .1]
