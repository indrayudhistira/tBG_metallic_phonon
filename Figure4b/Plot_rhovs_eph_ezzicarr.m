...
load Rho_vs_theta_relaxezzicarr_new_T10_n5.mat
...
plot(linspace(1.0248,1.0248,10),linspace(0.,0.017,10),'r','LineWidth',3)
plot(linspace(0.96,0.96,10),linspace(0.,0.02,10),'r','LineWidth',3)

thetam = 0.99; % for relaxed carr
...
annotation('textbox', [0 0.8 .1 .1], 'String', '(b)', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
...
ax = gca;
% exportgraphics(ax,'Fig-Relax-a.pdf','Resolution',300) 
