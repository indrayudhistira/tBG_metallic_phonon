...
%         errorbar(deg, param(1), paramdelta(1), [clr(k) 's'], 'LineWidth', 2, 'MarkerSize', 15);
...
%         %Exception
%         k0 = 0;
%         if (deg == 1.11 || deg == 1.24 || deg == 1.59 || deg == 2.02) && k == 1
%             xpos = deg + [-(w / 2)  0];
%             xposrect = deg - w / 2;
%             wrect = w / 2;
...
%         rectangle('Position', [xposrect min([y1 y2]) wrect h], 'FaceColor', [clrcode{k + k0} 0.4], 'EdgeColor', 'none', 'LineWidth', 1);  %clrcodeezzi{k}              
        deltadeg = 0.018;
        if k == 1
...
%annotation('textbox', [0.23 0.8133 .1 .1], 'String', 'Planckian theory', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
% annotation('textbox', [0.16 0.4133 .1 .1], 'String', 'Planckian fluid', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 25);
annotation('textbox', [.14 .8 .1 .1], 'String', '(d) Planckian theory', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 30);
% annotation('textbox', [.28 .79 .1 .1], 'String', {'Planckian', 'theory'}, 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 30);
% annotation('textbox', [0.757 0.53 .1 .1], 'String', 'Theory', 'LineStyle', 'none','Interpreter', 'latex', 'FontSize', 22);
